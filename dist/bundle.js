...
var getAllButton = document.getElementById("getAllButt");
getAllButton.addEventListener("click", GetAll);
var getByIDButton = document.getElementById("getByIdButt");
getByIDButton.addEventListener("click", GetByID);
var deleteByIDButton = document.getElementById("deleteByIdButt");
deleteByIDButton.addEventListener("click", DeleteByID);
var postButton = document.getElementById("postButt");
postButton.addEventListener("click", Post);
var putButton = document.getElementById("putButt");
putButton.addEventListener("click", Put);
// HTTPGet api/customer
function GetAll() {
    var uri = "https://customerserviceapi.azurewebsites.net/api/customer";
...
function GetByID() {
    ...
    var uri = "https://customerserviceapi.azurewebsites.net/api/customer/" + id;
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(uri)
        .then(function (response) {
        console.log(response.data);
        var result = "<ol>";
...
//HTTPPost
function Post() {
    var myCustomer = { id: 10, firstName: "Test", lastName: "Test", year: 1000 };
    var uri = "https://customerserviceapi.azurewebsites.net/api/customer";
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(uri, myCustomer)
        .then(function (response) {
        console.log(response.data);
        console.log(response.statusText);
    })
...
//HTTPPut
function Put() {
    var myCustomer = { id: 20, firstName: "Test2", lastName: "Test2", year: 2000 };
    var idInput = document.getElementById("idInput");
    var id = parseInt(idInput.value) - 1;
    var uri = "https://customerserviceapi.azurewebsites.net/api/customer/" + id;
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.put(uri, myCustomer)
        .then(function (response) {
        console.log(response.data);
        console.log(response.statusText);
    })
